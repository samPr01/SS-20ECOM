...
const generateWomenWesternProducts = (): Product[] => {
  ...
  for (let i = 1; i <= 500; i++) {
    ...
    let basePrice = 800;
    if (productType.includes("Blazer") || productType.includes("Jacket"))
      basePrice = 2000;
    else if (productType.includes("Dress") || productType.includes("Jumpsuit"))
      basePrice = 1500;
    else if (productType.includes("Jeans") || productType.includes("Trousers"))
      basePrice = 1200;
    else if (productType.includes("Top") || productType.includes("Shirt"))
      basePrice = 700;
    else if (productType.includes("Shorts") || productType.includes("Skirt"))
      basePrice = 900;
