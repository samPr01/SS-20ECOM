...
const productDefinitions = {
  womenEthnic: {
    brands: ["Saree Palace", "Ethnic Studio", "Royal Collection", "Indo Western", "Silk Heritage", "Handloom Studio", "Bridal Collection", "Fashion Forward", "Heritage Silk", "Ethnic Couture"],
    types: ["Saree", "Kurti", "Lehenga", "Anarkali Dress", "Palazzo Set", "Sharara Set", "Dupatta Set", "Ethnic Gown", "Churidar Set", "Straight Suit"],
    descriptors: ["Embroidered", "Printed", "Plain", "Block Print", "Digital Print", "Hand Work", "Zari Work", "Thread Work", "Sequin Work", "Mirror Work"],
    basePrice: 800,
    priceVariance: 0.8
  },
  womenWestern: {
    brands: ["Urban Style", "Summer Vibes", "Denim Co", "Trendy Tops", "Fashion Forward", "Professional Wear", "Casual Chic", "Party Collection", "Classic Shirts", "Comfort Wear"],
    types: ["Dress", "Top", "Jeans", "Skirt", "Jumpsuit", "Blazer", "Shirt", "Shorts", "Co-ord Set", "Trousers"],
    descriptors: ["Solid", "Striped", "Polka Dot", "Floral", "Geometric", "Abstract", "Animal Print", "Checked", "Plaid", "Tropical"],
    basePrice: 900,
    priceVariance: 0.7
  },
  men: {
    brands: ["Urban Basics", "Professional", "Denim Studio", "Sport Classic", "Casual Wear", "Street Style", "Traditional", "Summer Collection", "Formal Wear", "Athletic Wear"],
    types: ["T-Shirt", "Shirt", "Jeans", "Polo", "Chinos", "Hoodie", "Kurta", "Shorts", "Blazer", "Track Suit"],
    descriptors: ["Cotton", "Formal", "Slim Fit", "Regular Fit", "Casual", "Sports", "Ethnic", "Cargo", "Designer", "Premium"],
    basePrice: 700,
    priceVariance: 0.8
  },
  kids: {
    brands: ["Little Angels", "Fun Wear", "Princess Collection", "Learning Toys", "Mini Fashion", "Creative Toys", "School Essentials", "Cuddly Friends", "Active Kids", "Creative Corner"],
    types: ["Romper", "T-Shirt", "Dress", "Toy", "Jacket", "Building Blocks", "Backpack", "Soft Toy", "Shoes", "Art Kit"],
    descriptors: ["Baby", "Cartoon", "Party", "Educational", "Cotton", "Creative", "School", "Sports", "Colorful", "Interactive"],
    basePrice: 500,
    priceVariance: 0.9
  },
  electronics: {
    brands: ["Audio Pro", "FitTech", "Power Plus", "Sound Box", "Connect Pro", "Tech Accessories", "Mobile Guard", "Light Tech", "Video Pro", "Game Master"],
    types: ["Headphones", "Watch", "Power Bank", "Speaker", "Cable", "Mouse", "Phone Case", "Lamp", "Webcam", "Keyboard"],
    descriptors: ["Wireless", "Smart", "Bluetooth", "USB", "LED", "Gaming", "HD", "Fast Charging", "Portable", "Premium"],
    basePrice: 1500,
    priceVariance: 1.2
  }
};
...
function generateCategoryProducts(
  ...
  for (let i = 0; i < count; i++) {
    ...
    const descriptor = def.descriptors[Math.floor(Math.random() * def.descriptors.length)];
...
export const allProducts = {
  ...
  homeKitchen: [
    ...Array(450).fill(0).map((_, i) => ({
      ...
      brand: ['Kitchen Pro', 'Coffee Culture', 'Organize It', 'Light Up', 'Art House'][i % 5]
    }))
  ],
  beauty: [
    ...Array(400).fill(0).map((_, i) => ({
      ...
      brand: ['Natural Glow', 'Skin Care Pro', 'Beauty Tools', 'Hair Essentials', 'Color Pop'][i % 5]
    }))
  ],
  jewellery: [
    ...Array(350).fill(0).map((_, i) => ({
      id: 4100 + i,
      ...
      brand: ['Golden Heritage', 'Silver Craft', 'Luxury Gems', 'Pearl Collection', 'Time Style'][i % 5]
    }))
  ],
  bags: [
    ...Array(350).fill(0).map((_, i) => ({
      ...
      brand: ['SportFit', 'Professional', 'Street Style', 'Luxury Collection', 'Adventure Gear'][i % 5]
    }))
  ],
  sports: [
    ...Array(350).fill(0).map((_, i) => ({
      ...
      brand: ['Fitness Pro', 'Strength Max', 'Cricket Pro', 'Sports Zone', 'Workout Gear'][i % 5]
    }))
  ],
  automotive: [
    ...Array(300).fill(0).map((_, i) => ({
      ...
      brand: ['Drive Safe', 'Safety First', 'Fresh Drive', 'Mount Pro', 'Comfort Drive'][i % 5]
    }))
  ],
  office: [
    ...Array(250).fill(0).map((_, i) => ({
      ...
      brand: ['Comfort Office', 'Tech Workspace', 'Furniture Plus', 'Write Pro', 'Organize It'][i % 5]
    }))
  ]
};
